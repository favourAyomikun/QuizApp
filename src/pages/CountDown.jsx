...
const Countdown = () => {
  const [isCounting, setIsCounting] = useState(5);
  ...
  return (
    <div className="text-white flex flex-col justify-center h-screen text-center">
      ...
      <p className="text-base md:text-xl mt-5">{isCounting}</p>
    </div>
  );
};
